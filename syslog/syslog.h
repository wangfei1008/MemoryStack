...
#ifdef  WX_API_DLL
#define WX_API_DLL extern "C" __declspec(dllimport)
#else
#define WX_API_DLL extern "C" __declspec(dllexport)
#endif
...
WX_API_DLL int logopen();
WX_API_DLL int logwrite(int level, const char* filename, const int line, const char* funname, const char* fmt, ...);
WX_API_DLL void logclose();
WX_API_DLL void logsetparm(char type);
